        ...
        if not self.config.deterministic:
            artifact = run_structured_sdk_agent(
                ...
                instructions=(
                    ...
                    "IMPORTANT: All narration, text overlays, scene titles, and user-facing text must be in Chinese (Simplified). "
                    "The MathPacket metadata contains 'requested_duration_seconds'. Adjust the number of scenes "
                    "and per-scene duration_seconds to fill the requested total duration appropriately."
                ),
            ...
            scenes.append(
                StoryboardScene(
                    ...
                    metadata={
                        ...
                        "manim_primitives": ["Scene", "Text", "VGroup", "FadeIn", "Transform"],
                    },
                )
            )
