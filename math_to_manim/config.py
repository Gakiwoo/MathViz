...
class RuntimeConfig:
    ...
    def with_options(self, **kwargs: object) -> RuntimeConfig:
        """Return a new instance with the given fields overridden."""
        return RuntimeConfig(**{**self.__dict__, **kwargs})
    ...
    def from_env(cls) -> RuntimeConfig:
        ...
        load_env_file()
        load_env_file(Path(".env.m2m2"))
        codex_workdir = os.getenv("M2M2_CODEX_WORKDIR")
        return cls(
            model=os.getenv("M2M2_MODEL", os.getenv("OPENAI_MODEL", "deepseek-v4-flash")),
